...
export default class TalentMatching extends React.Component {
    ...
    //loadJobs(data) { // url: 'https://talentjobservices.azurewebsites.net/listing/listing/getEmployerJobs',
        
    //loadSelectedJob(data) url: 'https://talentjobservices.azurewebsites.net/listing/listing/getJobForTalentMatching',

    //loadTalentList()  url: 'https://mvptalentprofile.azurewebsites.net/profile/profile/getTalentList',

    //loadTalentFilterList() //url: 'https://mvptalentprofile.azurewebsites.net/profile/profile/getTalentListFilter',

    //loadEmployerFilterList() //url: 'https://mvptalentprofile.azurewebsites.net/profile/profile/getEmployerListFilter',


    // loadEmployerList() // url: 'https://mvptalentprofile.azurewebsites.net/profile/profile/getEmployerList',
    //loadSuggestionList   url: 'https://mvptalentprofile.azurewebsites.net/profile/profile/getSuggestionList',

   // saveCompanyTalents()   url: 'https://mvptalentprofile.azurewebsites.net/profile/profile/addTalentSuggestions',
     

    //saveJobTalents()    url: 'https://mvptalentprofile.azurewebsites.net/profile/profile/addTalentSuggestions',
