...
export default class EmployeeProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://mvptalentprofile.azurewebsites.net/profile/profile/getEmployerProfile',
            headers: {
            ...
            success: function (res) {
                ...
                if (res.employer) {
                    ...
                    //alert(employerData.primaryContact.firstName + employerData.primaryContact.lastName)
    ...
    saveData() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://mvptalentprofile.azurewebsites.net/profile/profile/saveEmployerProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
